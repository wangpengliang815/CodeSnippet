namespace RedisHelp
{
    ...
    public class RedisHelper
    {
        ...
        public RedisHelper(int dbNum, string customKeyPrefix, string redisConnectionString)
        {
        ...
        /// <returns></returns>
        public bool SetString<T>(string key, T @object, TimeSpan? expiry = default)
        {
            key = GenerateCustomKey(key);
        ...
        /// <returns></returns>
        public RedisValue[] GetString(List<string> listKeys)
        {
            List<string> redisKeys = listKeys.Select(GenerateCustomKey).ToList();
            return db.StringGet(ConvertRedisKeys(redisKeys));
        }
        ...
        {
            key = GenerateCustomKey(key);
            return ConvertObject<T>(db.StringGet(key));
        }
        ...
        //{
        //    return conn.GetDatabase(DbNumber);
        //}
